...
**New Features:**
- **Active Defense Honeypot**: A dedicated honeypot on port 2323 instantly isolates attackers.
- **Live Dashboard**: Real-time graph visualization of attack traffic.
...
- **Honeypot** traps attackers on port 2323.
- **Event Engine** processes alerts and updates live stats.
